...
import HelloWorldTCR_CHROME
from HelloWorldTCR_CHROME.lib.curve.ttypes import *
from datetime import datetime
from dateutil import tz
from threading import Thread
import time,random,sys,json,codecs,threading,glob,re,ast,os,subprocess,requests,goslate,urllib,urllib2,urllib3,os,pytz,calendar
    ...
    try:
        ...
        if op.type == 13:
            if op.param2 in admin:
                ...
                verify.append(contact.mid)
            else:
                cl.sendText(op.param1,"Kick aja deh orgnya entr kebiasaan")
                cl.kickoutFromGroup(op.param1,[op.param2])
        #------Cancclel Invite User Finish------#
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    ki.sendText(msg.to,"Hacker By Team Noob Bot")
                    targets = []
                    for g in gs.members:
...
#------------------------------------------------------------------
                ...
                try:
                    ...
                    try:
                        ...
                        pass	
        if op.type == 17:
            if op.param2 not in verify:
                ginfo = cl.getGroup(op.param1)
                cl.sendText(op.param1, "Heh diundang siapa nih org? tau-tau masuk")
                cl.kickoutFromGroup(op.param1,[op.param2])
            else:
                ginfo = cl.getGroup(op.param1)
                cl.sendText(op.param1, "Nah ini baru org yg gk nyasar")
        if op.type == 59:
            print op
